...
public class NoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSpinner_courses.setAdapter(adapterCourses);
        ...
        if(!mIsNewNote)
        displayNote(mSpinner_courses, mTextNoteTitle, mTextNoteText);
    }
    ...
    protected void onPause() {
        ...
        if(mCancelling){
            if(mIsNewNote) {
                //To remove the backing store created node as it will be empty
    ...
    private void sendEmail() {
        CourseInfo course = (CourseInfo) mSpinner_courses.getSelectedItem();
        String subject = mTextNoteTitle.getText().toString();
        String text = "Check out what I learned from this course \"" + course.getTitle()
